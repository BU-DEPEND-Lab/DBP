...
#ifndef FOOTBOT_TIME_SYNC_OSP
#define FOOTBOT_TIME_SYNC_OSP
 ...
 */
class CFootBotTimeSync_OSP : public CCI_Controller
{
...
public:
   ...
   struct SObservationSharingProtocolParams
   {
      ...
      bool is_byzantine;
      std::optional<UInt32> byzantine_offset;
      bool is_observer;
...
public:
   /* Class constructor. */
   CFootBotTimeSync_OSP();

   /* Class destructor. */
   virtual ~CFootBotTimeSync_OSP() {}
...
public:
   ...
   Real skew;
   Real local_time;
   TimeSyncObservationManager m_ObservationManager;
   AccusationManager<TimeSyncObservationValue> m_AccusationManager;
