...
#ifndef FOOTBOT_FLOCKING_WMSR_H
#define FOOTBOT_FLOCKING_WMSR_H
 ...
 */
class CFootBotFlocking_WMSR : public CCI_Controller
{
...
public:
   ...
   struct SResilientFlockingParams
   {
      size_t F;
      void Init(TConfigurationNode &t_node);
   };
...
public:
   /* Class constructor. */
   CFootBotFlocking_WMSR();

   /* Class destructor. */
   virtual ~CFootBotFlocking_WMSR() {}
...
protected:
   ...
   void SetBroadcastFromLinearUpdate();
...
private:
   ...
   SResilientFlockingParams m_sResilientFlockingParams;

public:
   std::optional<CVector2> x;
   std::optional<CVector2> obs;
};
