...
#ifndef FOOTBOT_FLOCKING_OSP_IC_H
#define FOOTBOT_FLOCKING_OSP_IC_H
 ...
 */
class CFootBotFlocking_OSP_IC : public CCI_Controller
{
...
public:
   ...
   struct SObservationSharingProtocolParams
   {
      ...
      std::size_t outbound_obs_limit;
      Real max_target_displacement;
      void Init(TConfigurationNode &t_node);
   };

public:
   /* Class constructor. */
   CFootBotFlocking_OSP_IC();

   /* Class destructor. */
   virtual ~CFootBotFlocking_OSP_IC() {}
...
protected:
   ...
   void MakeObservationOf(CVector2);
...
public:
   ...
   FlockingObservationManager m_ObservationManager;
   AccusationManager<FlockingObservationValue> m_AccusationManager;
