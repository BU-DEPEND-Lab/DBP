...
#ifndef FOOTBOT_FLOCKING_OSP_BYZANTINE_H
#define FOOTBOT_FLOCKING_OSP_BYZANTINE_H
 ...
 */
class CFootBotFlockingOSP_Byzantine : public CCI_Controller
{
...
public:
   /* Class constructor. */
   CFootBotFlockingOSP_Byzantine();

   /* Class destructor. */
   virtual ~CFootBotFlockingOSP_Byzantine() {}
...
private:
   ...
   SByzantineParams m_sByzantineParams;
