...
#ifndef FOOTBOT_FLOCKING_BYZANTINE_H
#define FOOTBOT_FLOCKING_BYZANTINE_H
 ...
 */
class CFootBotFlockingByzantine : public CCI_Controller
{
...
public:
   /* Class constructor. */
   CFootBotFlockingByzantine();

   /* Class destructor. */
   virtual ~CFootBotFlockingByzantine() {}
