...
#ifndef FOOTBOT_TIME_SYNC_WMSR
#define FOOTBOT_TIME_SYNC_WMSR
 ...
 */
class CFootBotTimeSync_WMSR : public CCI_Controller
{
...
public:
   ...
   struct SResilientTimeSyncParams
   {
      size_t F;
      bool is_byzantine;
...
public:
   /* Class constructor. */
   CFootBotTimeSync_WMSR();

   /* Class destructor. */
   virtual ~CFootBotTimeSync_WMSR() {}
...
public:
   ...
   SResilientTimeSyncParams m_sResilientTimeSyncParams;
   Real local_time;
   Real skew;
