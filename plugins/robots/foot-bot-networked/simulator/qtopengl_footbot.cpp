...
namespace argos {
   ...
   void CQTOpenGLFootBot::Draw(CFootBotNetworkedEntity& c_entity) {
      /* Place the wheels */
      glPushMatrix();
   ...
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CFootBotNetworkedEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawFootBotNormal, CFootBotNetworkedEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawFootBotSelected, CFootBotNetworkedEntity);
