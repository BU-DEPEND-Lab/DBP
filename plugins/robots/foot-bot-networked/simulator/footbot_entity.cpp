...
namespace argos {
   ...
   CFootBotNetworkedEntity::CFootBotNetworkedEntity() :
   ...
   CFootBotNetworkedEntity::CFootBotNetworkedEntity(const std::string& str_id,
   ...
   void CFootBotNetworkedEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
         ...
         AddComponent(*m_pcBatteryEquippedEntity);
         /* radio equipped entity */
         m_pcSimpleRadioEquippedEntity = new CSimpleRadioEquippedEntity(this, "simple_radios_0");
         SAnchor& sOriginAnchor = m_pcEmbodiedEntity->GetOriginAnchor();
         std::string strRadioMedium = "radios";
         Real transmission_range(1.0);
         GetNodeAttributeOrDefault(t_tree, "radio_medium", strRadioMedium, strRadioMedium);
         GetNodeAttributeOrDefault(t_tree, "transmission_range", transmission_range, transmission_range);
         if(!strRadioMedium.empty()) {
            CSimpleRadioMedium& cRadioMedium = CSimulator::GetInstance().GetMedium<CSimpleRadioMedium>(strRadioMedium);
            m_pcSimpleRadioEquippedEntity->AddRadio("radio",
   ...
   void CFootBotNetworkedEntity::Reset() {
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CFootBotNetworkedEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CFootBotNetworkedEntity,
                   "foot-bot-networked",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The foot-bot robot, developed in the Swarmanoid project. (+radio)",
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CFootBotNetworkedEntity);
