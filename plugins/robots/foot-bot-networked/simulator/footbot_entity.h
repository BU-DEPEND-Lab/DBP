...
#ifndef FOOTBOTNETWORKED_ENTITY_H
#define FOOTBOTNETWORKED_ENTITY_H
...
namespace argos {
   ...
   class CFootBotNetworkedEntity : public CComposableEntity {
   ...
   public:
      ...
      CFootBotNetworkedEntity();

      CFootBotNetworkedEntity(const std::string& str_id,
      ...
      inline CSimpleRadioEquippedEntity& GetSimpleRadioEquippedEntity() {
         ARGOS_ASSERT(m_pcSimpleRadioEquippedEntity != nullptr,
                      "CFootBotNetworked::GetSimpleRadioEquippedEntity(), id=\"" <<
                      GetId() + GetContext() <<
